...
if __name__== "__main__" :
    ...
    w4=tk.Label(root,text="Abhijeet Kumar | Abhijith J K | Amisha Asrani | Anjali Sharma",image=student,font=("Bitstream Charter",15,"italic bold"),bg="white",compound="left",padx=10,pady=5,anchor="s",width=770)
